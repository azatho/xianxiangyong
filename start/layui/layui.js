...
! function(e) {
	...
	r.prototype.cache = n, r.prototype.define = function(e, t) {
		...
		function c(e, t) {
			...
			("load" === e.type || r.test((e.currentTarget || e.srcElement).readyState)) && (n.modules[d] = t, y
				.removeChild(h),
				function o() {
		...
		if (l = l || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 ===
			e.length || layui["layui.all"] && u[d] || !layui["layui.all"] && layui["layui.mobile"] && u[d])
		return s(), p;
		var v = (u[d] ? f + "lay/" : /^\{\/\}/.test(p.modules[d]) ? "" : n.base || "") + (p.modules[d] || d) +
		".js";
		if (v = v.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = v), n.modules[d]) !
			function g() {
				return ++m > 1e3 * n.timeout / 4 ? a(d + " is not a valid module") : void("string" == typeof n
					.modules[d] && n.status[d] ? s() : setTimeout(g, 4))
			}();
		else {
		...
		return u.rel = "stylesheet", u.href = e + (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", t
			.getElementById(s) || l.appendChild(u), "function" != typeof r ? i : (function f() {
				return ++p > 1e3 * n.timeout / 100 ? a(e + " timeout") : void(1989 === parseInt(i.getStyle(t
		...
		if (t = t || "layui", r = r || localStorage, e.JSON && e.JSON.parse) {
			...
			return "value" in n && (o[n.key] = n.value), n.remove && delete o[n.key], r[t] = JSON.stringify(o), n
				.key ? o[n.key] : o
		}
		...
		return t && !o[t] && (o[t] = r(t)), o.android = /android/.test(n), o.ios = "ios" === o.os, o.mobile = !(!o
			.android && !o.ios), o
